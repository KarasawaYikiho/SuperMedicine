...
LABELS: dict[str, str] = {
    ...
    "status_shortcuts_hint": "Tab/Shift+Tab 移动焦点 · Enter 提交 · M 菜单/选择视图 · P 权限模式 · ? 帮助 · F 最大化 · Q 退出",
    "thinking": "正在思考...",
    "chat_separator": "────────────────────────────────────────",
    "chat_user_label": "用户",
    ...
    "help_global": "全局：M 菜单/选择视图 | P 权限模式 | Q 退出 | ? 帮助 | F 最大化/还原焦点组件 | Esc 退出最大化或返回菜单上级",
    "help_escape_hint": "按 Esc 可退出最大化",
    "menu_title": "SuperMedicine 菜单",
    "menu_open": "菜单",
    "menu_close": "关闭菜单",
    "menu_back": "返回上级菜单",
