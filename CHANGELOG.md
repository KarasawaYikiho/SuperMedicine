...
This file records user-visible changes by release. It follows
[Keep a Changelog](https://keepachangelog.com/en/1.1.0/); Python distribution
versions use the compatible subset of
