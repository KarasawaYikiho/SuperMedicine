...
- [INSTALL.md](docs/guides/INSTALL.md) — 安装、Provider 配置、发布包布局、可选 R 支持和卸载行为。
- [ARCHITECTURE.md](docs/architecture/ARCHITECTURE.md) — 微内核、插件、权限、适配器和仓库边界设计。
- [SECURITY.md](SECURITY.md) — 安全模型、密钥处理、医学使用限制和披露建议。
- [FUNCTION_MAP.md](docs/architecture/FUNCTION_MAP.md) — 静态 callable 清单及其限制。
