...
- Are axes, units, labels, and legends unambiguous?
- Are raw points visible when sample size is small?
...
- color-only encoding for important distinctions;
- mean-only bars hiding small samples;
- hidden missing data or unexplained outlier removal;
