...
- **Candidate test files:** `tests/test_permission_modes.py`, `tests/test_permission_engine.py`, `tests/test_policy.py`, `tests/test_path_safety.py`, `tests/test_tui.py`, `tests/test_tui.py`, `tests/test_tui_state.py`.
...
- **Acceptance commands:** `python -m pytest tests/test_permission_modes.py tests/test_permission_engine.py tests/test_policy.py tests/test_path_safety.py tests/test_tui.py tests/test_tui.py tests/test_tui_state.py`
...
- **Candidate test files:** `tests/test_workspace_full.py`, `tests/test_plugin_registry.py`, `tests/test_tui.py`, `tests/test_workspace.py`, `tests/test_workspace_cli.py`, `tests/test_python_stats.py`, `tests/test_r_survival.py`.
...
- **Acceptance commands:** `python -m pytest tests/test_workspace_full.py tests/test_plugin_registry.py tests/test_tui.py tests/test_workspace.py tests/test_workspace_cli.py tests/test_python_stats.py tests/test_r_survival.py`
...
- **Candidate test files:** `tests/test_log_report.py`, `tests/test_tui.py`, `tests/test_session_manager.py`, `tests/test_event_bus.py`, `tests/test_redaction.py`, `tests/test_experiment_log_integration.py`.
...
- **Acceptance commands:** `python -m pytest tests/test_log_report.py tests/test_tui.py tests/test_session_manager.py tests/test_event_bus.py tests/test_redaction.py tests/test_experiment_log_integration.py`
...
- **Candidate test files:** `tests/test_llm_client.py`, `tests/test_llm_manager.py`, `tests/test_kernel_full.py`, `tests/test_tui.py`, `tests/test_tui_dialog_history.py`, `tests/test_tui_llm_screen.py`, `tests/test_tui_state.py`.
...
- **Acceptance commands:** `python -m pytest tests/test_llm_client.py tests/test_llm_manager.py tests/test_kernel_full.py tests/test_tui.py tests/test_tui_dialog_history.py tests/test_tui_llm_screen.py tests/test_tui_state.py`
...
- **Candidate test files:** `tests/test_orchestrator.py`, `tests/test_state_machine.py`, `tests/test_checkpoint.py`, `tests/test_opencode_adapter.py`, `tests/test_standalone_adapter.py`, `tests/test_integration.py`, `tests/test_kernel_full.py`.
...
- **Acceptance commands:** `python -m pytest tests/test_orchestrator.py tests/test_state_machine.py tests/test_checkpoint.py tests/test_opencode_adapter.py tests/test_standalone_adapter.py tests/test_integration.py tests/test_kernel_full.py`
...
- **Candidate test files:** `tests/test_tui.py`, `tests/test_tui.py`, `tests/test_workspace_full.py`, `tests/test_log_report.py`, TUI screen tests matching each proven stale surface.
...
- **DBG-BUG-005 / CI workspace refresh race:** existing `tests/test_tui.py` coverage already uses condition-based waiting for external workspace creation plus manual refresh, matching the CI root-cause regression path; no additional test required.
...
- **CI failure root cause:** Windows/Textual asynchronous refresh timing around `tests/test_tui.py::test_workspace_view_refresh_button_reads_external_workspace_created_after_enter`, where the table assertion ran before the UI reflected the externally created workspace.
- **CI repair:** `tests/test_tui.py::_wait_for_tui_condition` and the updated workspace refresh test wait for `DataTable.row_count == 1` before asserting the `external-a` row, aligning the regression with `core/tui/screens/workspace_screen.py` refresh behavior.
