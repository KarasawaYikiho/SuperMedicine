...
def get_consort_checklist() -> Checklist:
    ...
    return Checklist(
        ...
        items=[
            ...
            ChecklistItem("3b", "方法", "方法学变更", "描述试验开始后的任何重要方法学变更"),
            ChecklistItem("4a", "方法", "受试者", "描述受试者的纳入和排除标准"),
            ChecklistItem("4b", "方法", "数据收集", "描述数据收集的机构和地点"),
            ...
            ChecklistItem("11b", "结果", "随机分组", "报告每个随机分组的人数"),
            ChecklistItem("12a", "结果", "招募", "报告招募期和随访时间"),
            ChecklistItem("12b", "结果", "试验终止", "说明试验终止的原因"),
            ChecklistItem("13a", "结果", "基线数据", "报告各组的基线人口学和临床特征"),
            ChecklistItem("13b", "结果", "基线表", "提供基线数据表格"),
            ChecklistItem("14a", "结果", "分析人数", "报告每个分析中纳入的人数"),
            ChecklistItem("14b", "结果", "意向治疗", "是否采用意向治疗分析"),
            ...
            ChecklistItem("20", "讨论", "解读", "解释结果"),
            ChecklistItem("21", "其他", "注册", "提供试验注册号"),
            ChecklistItem("22", "其他", "方案", "提供完整方案的获取途径"),
            ChecklistItem("23", "其他", "资助", "提供资助来源"),
        ],
    )
...
def get_strobe_checklist() -> Checklist:
    ...
    return Checklist(
        ...
        items=[
            ...
            ChecklistItem("14b", "结果", "缺失数据", "描述缺失数据的处理"),
